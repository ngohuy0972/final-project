	...
	<section class="popular-items latest-padding">
			<div class="container">
					<div class="row product-btn justify-content-between mb-40">
                        ...
                        <a href="{{ route('sort-price')}}" class="nav-item nav-link active" id="pricesort" >Low Price</a>
									...
									<div class="row" id="list-product">
										...
										<div class="row col-xl-12 col-lg-12 col-md-12 col-sm-12" style="width: 100%;">
											<div class="room-btn pb-40">
													<button type="submit" id="btn-load-more" class="all-button" data-price="{{ $item->price}}">View More Products</button>
											</div>
									</div>
									</div>
									<!-- Button Load More-->
